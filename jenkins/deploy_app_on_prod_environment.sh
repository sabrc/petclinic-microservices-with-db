...
AWS_REGION=$AWS_REGION helm repo add stable-petclinic s3://petclinic-helm-charts-clarusway-repo/petclinic-app-prod/stable/myapp/ || echo "repository name already exists"
